...
export const authAPI = {
     ...
     */
    register: async (firebaseUid, email, displayName, phoneNumber = null) => {
...
export const transactionAPI = {
     ...
     * Send a transaction
     */
    send: async (receiverUpiId, amount, description = '') => {
     ...
     */
    getHistory: async (page = 1, perPage = 20, status = null) => {
     ...
     */
    getDetails: async (transactionRef) => {
...
export const adminAPI = {
     ...
     * Get fraud alerts
     */
    getAlerts: async (page = 1, perPage = 20, includeReviewed = false) => {
        const params = new URLSearchParams({ page, per_page: perPage, reviewed: includeReviewed });
     ...
     */
    reviewAlert: async (alertId, notes = '', action = 'reviewed') => {
